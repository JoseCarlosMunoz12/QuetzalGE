...
namespace MATH {
	...
	COATL_API void ClosestSeg_Seg(std::vector<glm::vec3> Seg0, std::vector<glm::vec3> Seg1,
	COATL_API 	glm::vec3 &Pos0,glm::vec3 &Pos1);
	//DistanceValue
	...
	COATL_API bool SATColCheck(std::vector<glm::vec3> Norm0, std::vector<glm::vec3> Norm1,
	COATL_API 	std::vector<glm::vec3> Pnts0,std::vector<glm::vec3> Pnts1);
	//Return Changes
	...
	// SAT Functions
	COATL_API void SetRejDir(glm::vec3& Max, glm::vec3& Min, glm::vec3 NewVal,
	COATL_API 	glm::vec3& RejMax, glm::vec3& RejMin,glm::vec3 OgSeg);
	...
	COATL_API std::vector<glm::vec3> Pnts0, std::vector<glm::vec3> Pnts1,glm::vec3 &Norm,
	COATL_API 	float R);
	...
	COATL_API void SAT_MAXMIN_Cul(glm::vec3& Max, glm::vec3& Min, glm::vec3 NewVal,int ID,
	COATL_API 	std::vector<int>& ID0, std::vector<int>& ID1);
